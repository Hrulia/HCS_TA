...
void handle_OnConnect() {
	...
	webServer.send(200, "text/html", prepareHtmlPage(true, true));
}
...
void handle_DoorAir() {
	...
	webServer.send(200, "text/html", prepareHtmlPage(true, false));
}
...
String prepareHtmlPage(uint8_t led1stat, uint8_t led2stat){
	String htmlPage;
...
/*
	...
	*/
	htmlPage = F("<!DOCTYPE html>"
		...
		"<td>Дымовые газы</td>"
		"<td>225.6</td>"
		"<td><input type='text' class='txtGray' name='tempFlueGas'></input></td>"
		"<td><button formaction='/SetFlueGas'>Send</td>"
		"</tr>"
		"<tr>"
		"<td>ТТК подача</td>"
		"<td>25.6</td>"
		...
		"<form style='position:absolute; top:80px;left:450px; height:500px; width:600px'>"
		"<table cellspacing='0' cellpadding='5'>"
		...
		"<div id='container' style='position:absolute;top:80px;left:830px;height:500px;width:600px'></div>"
